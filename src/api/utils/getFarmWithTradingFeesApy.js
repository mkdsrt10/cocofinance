...
const { incorporateBifiFee } = require('./incorporateBifiFee');
...
const getFarmWithTradingFeesApy = (
  ...
  const farmApy = incorporateBifiFee(farmApr, compoundingsPerYear, t, shareAfterBeefyPerformanceFee);
  const tradingApy = incorporateBifiFee(tradingApr, compoundingsPerYear, t, 1); // no fee on trading
